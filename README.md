# Declarations of terms tracked in the *<!-- here goes your collection name -->Generative AI Contrib<!-- until here -->* collection
...
You can [explore the tracked versions](https://github.com/OpenTermsArchive/genai-contrib-versions) interactively or [download them as a dataset](https://github.com/OpenTermsArchive/genai-contrib-versions/releases) in the `OpenTermsArchive/genai-contrib-versions` repository.
